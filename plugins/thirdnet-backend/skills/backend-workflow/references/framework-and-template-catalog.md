...
| 实体/DbContext/迁移/分组查询 | `net-efcore-developer` | 1.1 query、1.2 model |
| 缓存域/RedisCacheManager/锁 | `net-cache-use` | 1.1 redis、2 缓存域 |
| 批量增改同步 | `net-database-bulkcopy` | 1.1 database |
| 认证/加密/Token | `net-authentication` | 1.1 algorithm、1.2 认证 |
| 权限/角色/菜单/scope | `net-rbac` | 1.2 授权、2 OperatorContext |
