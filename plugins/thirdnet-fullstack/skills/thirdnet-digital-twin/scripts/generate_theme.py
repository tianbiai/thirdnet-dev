...
Usage:
  ...
  python generate_theme.py night-realistic --out src/styles/tokens.css
...
def main(argv=None) -> int:
    ...
    p.add_argument("style", nargs="?", help="风格名（cyber/realistic/night-realistic/blueprint/holographic/white-model/isometric）")
